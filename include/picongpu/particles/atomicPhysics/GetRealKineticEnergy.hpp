        ...
        namespace atomicPhysics
        {
            struct GetRealKineticEnergy
            {
                ...
                HDINLINE static float_X KineticEnergy(T_Particle const& particle)
                {
                    ...
                    float_X momentum_p_SI_rel = c_SI * (momentum * picongpu::UNIT_MASS * picongpu::UNIT_LENGTH
                        / picongpu::UNIT_TIME) ; // unit: J, SI
                    ...
                    return math::sqrt(m_p_SI_rel * m_p_SI_rel + momentum_p_SI_rel * momentum_p_SI_rel) - m_p_SI_rel;
