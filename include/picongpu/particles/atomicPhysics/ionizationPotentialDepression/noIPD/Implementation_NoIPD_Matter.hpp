...
/** @file NoIPD matter ionization potential depression(IPD) implementation
 *
 * Implements the interface for skipping matter IPD models in the atomicPhysics stage.
 */
...
{
    struct Implementation_NoIPD_Matter : MatterIPDImplementation
    {
