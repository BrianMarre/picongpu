...
namespace picongpu::particles::atomicPhysics::ionizationPotentialDepression
{
    struct PassIPDInputs
    {
        ...
        HDINLINE static T_IPDModel::SuperCellConstantInput getSuperCellConstantInput_RNGFactory(
            pmacc::DataSpace<picongpu::simDim> const superCellFieldIdx,
            T_RNGFactory&,
            T_ChargeStateDataBox,
            T_IPDInput... ipdInput)
        {
            return T_IPDModel::template getSuperCellConstantInput(superCellFieldIdx, ipdInput...);
        }

        template<typename T_IPDModel, typename T_ChargeStateDataBox, typename... T_IPDInput>
        HDINLINE static T_IPDModel::SuperCellConstantInput getSuperCellConstantInput(
            pmacc::DataSpace<picongpu::simDim> const superCellFieldIdx,
            T_ChargeStateDataBox,
            T_IPDInput... ipdInput)
        {
