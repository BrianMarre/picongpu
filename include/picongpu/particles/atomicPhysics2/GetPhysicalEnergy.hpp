...
namespace picongpu::particles::atomicPhysics2
{
    struct GetPhysicalEnergy
    {
        ...
        HDINLINE static float_X KineticEnergy(T_Particle const& particle)
        {
            ...
            float_64 const m = static_cast<float_64>(attribute::getMass(1.0_X, particle));
            // internal units, not scaled
            ...
            // u_l^2 / (u_t^2*c_SI) = 1
            float_X energy = (math::sqrt(m * m + momentumSquared * conversionFactor) - m); // unit: u_m * c_SI^2
