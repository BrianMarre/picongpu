...
{
    /**helper superCell field of sum of weights of all electron macro particles.
     *
     * @details required for calculating local debye length for ionization potential depression(IPD)
