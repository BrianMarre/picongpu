...
namespace picongpu::particles::atomicPhysics2::atomicData
{
    ...
    public:
         ...
         * @attention no range checks outside debug compile, invalid memory , invalid memory access if collectionIndex >= numberTransitions
         *
        ...
        * @param collectionIndex ... collection index of transition
        *
        * @attention no range checks outisde debug compile, invalid memory , invalid memory access if collectionIndex >= numberTransitions
        */
    ...
    template<
        ...
        typename T_CollectionIndex,
        uint8_t T_atomicNumber>
    class BoundFreeTransitionDataBuffer : public TransitionDataBuffer< T_Number, T_Value, T_CollectionIndex, T_atomicNumber>
    {
    public:
    ...
    public:
        ...
        HINLINE BoundFreeTransitionDataBuffer(uint32_t numberBoundFreeTransitions)
            : TransitionDataBuffer< T_Number, T_Value, T_CollectionIndex, T_atomicNumber>(numberBoundFreeTransitions)
        {
        ...
        HINLINE BoundFreeTransitionDataBox< T_Number, T_Value, T_CollectionIndex, T_atomicNumber> getHostDataBox()
        {
            return BoundFreeTransitionDataBox<
                ...
                this->bufferLowerCollectionIndex->getHostBuffer().getDataBox(),
                this->bufferUpperCollectionIndex->getHostBuffer().getDataBox(),
                this->m_numberTransitions);
        }

        HINLINE BoundFreeTransitionDataBox< T_Number, T_Value, T_CollectionIndex, T_atomicNumber> getDeviceDataBox()
        {
            return BoundFreeTransitionDataBox<
                T_Number,
                T_Value,
                ...
                this->bufferLowerCollectionIndex->getDeviceBuffer().getDataBox(),
                this->bufferUpperCollectionIndex->getDeviceBuffer().getDataBox(),
                this->m_numberTransitions);
        }
