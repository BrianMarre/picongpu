...
namespace picongpu::particles::atomicPhysics2::atomicData
{
    ...
    T_ConfigNumberDataType getLowerStateConfigNumber(
        atomicData::BoundBoundTransitionTuple<T_Value, T_ConfigNumberDataType>& tupel)
    {
    ...
    template<typename T_ConfigNumberDataType, typename T_Value = float_X>
    T_ConfigNumberDataType getLowerStateConfigNumber(
        atomicData::BoundFreeTransitionTuple<T_Value, T_ConfigNumberDataType>& tupel)
    {
        return std::get<8>(tupel);
    }
    ...
    template<typename T_ConfigNumberDataType, typename T_Value = float_X> // T_Value only to keep interface consistent
    T_ConfigNumberDataType getLowerStateConfigNumber(
        atomicData::AutonomousTransitionTuple<T_ConfigNumberDataType>& tupel)
    {
